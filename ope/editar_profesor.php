<?php
	...
	if (empty($_POST['mod_id'])) {
		...
		$id_profesor=intval($_POST['mod_id']);
		$sql="UPDATE profesores SET NOMBRE='".$nombre."', EDAD='".$edad."', CEDULA='".$cedula."', TELEFONO='".$telefono."', ESTADO='".$estado."' WHERE ID='".$id_profesor."'";
		$query_update = mysqli_query($con,$sql);
			if ($query_update){
				$messages[] = "El Profesor ha sido actualizado satisfactoriamente.";
			} else{
